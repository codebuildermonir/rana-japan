...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        label: "N5 Course Outline",
        link: "#",
      },
      {
        label: "Contact to Admission",
        link: "#",
      },
    ],
  },
...
export default function NavBar() {
  ...
  return (
    <div className="container  mx-auto flex px-4 lg:px-6 py-5">
        ...
        <a href="#">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop stop-color="#2ae1a9" />
                <stop offset="0.993738" stop-color="#2ae1a9" />
              </linearGradient>
              <linearGradient
              ...
              <p className="flex cursor-pointer items-center gap-2 text-neutral-800 group-hover:text-black ">
                ...
                {d.children && (
                  ...
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="size-5 rotate-180 transition-all group-hover:rotate-0"
                  >
...
function MobileNav({ closeSideMenu }: { closeSideMenu: () => void }) {
  return (
    <div className="fixed left-0 z-10 top-0 flex h-full min-h-screen w-full justify-end bg-black/60 md:hidden">
      ...
      <p className="flex cursor-pointer items-center gap-2 text-neutral-800 group-hover:text-black ">
        ...
        {d.children && (
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className={`text-xs transition-all size-5 ${
